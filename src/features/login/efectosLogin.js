// Efectos del login: el oleaje del fondo y la intro de marca al entrar.
//
...
/** Mismo criterio que el tour: modo liviano del pañol o "reducir movimiento" del sistema. */
...
export function debeMostrarIntro(perfil) {
  if (!perfil || movimientoReducido()) return false;

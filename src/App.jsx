...
// SOLO el icono (no el logo largo)
import logoK from "./assets/logo-k.png";

// Si querés fondo, descomentá y poné una imagen en src/assets/login-bg.jpg
...
function LoginScreen({ onLoggedIn }) {
  ...
  return (
    <div style={S.page}>
      {/* Fondo opcional:
      <img src={loginBg} alt="" style={S.bg} />
      */}
      <div style={S.overlay} />
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={S.inputWrap}>
              ...
              <input
                style={S.input}
                placeholder="ADMIN / PANOL1 / OFICINA1"
                value={username}

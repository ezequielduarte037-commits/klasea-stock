-- El producto del catalogo elegido al armar el aviso no se guardaba en el
-- renglon: panol_crear_envio leia material_id del payload pero el insert en
-- panol_envio_items no lo incluia en la lista de columnas.
--
-- Se rescataba solo por rebote: un disparador copia el material desde la fila
-- de obra, asi que los renglones CON obra quedaban vinculados y los que van a
-- "Stock general" perdian el vinculo. De ahi que en agosto 40 de 57 renglones
-- llegaran al panol sin producto y el panolero tuviera que volver a elegirlo.
--
-- Unico cambio respecto de 20260709100000: material_id en el insert.
